import { DIDRulesViewModel } from '@/lib/core/view-model/did';
...
class ListDIDRulesUseCase
    extends BaseSingleEndpointPostProcessingPipelineStreamingUseCase<
        ...
        DIDRulesViewModel
    >
    implements ListDIDRulesInputPort
{
    constructor(
        ...
        const getSubscriptionByIdPipelineElement: GetDIDSubscriptionsByIDPipelineElement = new GetDIDSubscriptionsByIDPipelineElement(

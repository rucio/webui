...
import { DIDDatasetReplicasViewModel } from '@/lib/core/view-model/did';
...
@injectable()
export default class ListDatasetReplicasUseCase
    ...
    >
    implements ListDatasetReplicasInputPort
{
    constructor(protected readonly presenter: ListDatasetReplicasOutputPort, private readonly gateway: ReplicaGatewayOutputPort) {
        super(presenter);
    }
    ...
    intializeRequest(
        request: AuthenticatedRequestModel<AuthenticatedRequestModel<ListDatasetReplicasRequest>>,
    ): Promise<ListDatasetReplicasError | undefined> {

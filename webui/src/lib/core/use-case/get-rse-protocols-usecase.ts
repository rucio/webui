...
@injectable()
export default class GetRSEProtocolsUseCase
    extends BaseSingleEndpointUseCase<
        AuthenticatedRequestModel<GetRSEProtocolsRequest>,
        GetRSEProtocolsResponse,
        GetRSEProtocolsError,
        RSEProtocolDTO
    >
    implements GetRSEProtocolsInputPort
{
    constructor(protected readonly presenter: GetRSEProtocolsOutputPort, private readonly gateway: RSEGatewayOutputPort) {
        super(presenter);
    }

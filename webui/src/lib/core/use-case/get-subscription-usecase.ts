...
class GetSubscriptionUseCase
    extends BaseSingleEndpointUseCase<
        AuthenticatedRequestModel<GetSubscriptionRequest>,
        GetSubscriptionResponse,
        GetSubscriptionError,
        SubscriptionDTO
    >
    implements GetSubscriptionInputPort
{
    constructor(protected readonly presenter: GetSubscriptionOutputPort, private readonly gateway: SubscriptionGatewayOutputPort) {
        super(presenter);
    }

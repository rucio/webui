...
import { DIDMetaViewModel } from '@/lib/core/view-model/did';
import { LoadingSpinner } from '@/component-library/atoms/loading/LoadingSpinner';
import { TabSwitcher } from '@/component-library/features/tabs/TabSwitcher';
import { DetailsDIDView, DetailsDIDProps } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDView';
import { DetailsDIDAttributes } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDAttributes';
import { DetailsDIDFileReplicas } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDFileReplicas';
import { useState } from 'react';
import { DetailsDIDMeta } from '@/lib/infrastructure/client/pages/DID/details/DetailsDIDMeta';
import { DIDType } from '@/lib/core/entity/rucio';
import { DetailsDIDRules } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDRules';
import { cn } from '@/component-library/utils';
import { DetailsDIDParents } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDParents';
import { DetailsDIDContents } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDContents';
import { DetailsDIDContentsReplicas } from '@/lib/infrastructure/client/pages/DID/details/views/DetailsDIDContentsReplicas';

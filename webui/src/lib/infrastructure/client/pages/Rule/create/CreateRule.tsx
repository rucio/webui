...
} from '@/lib/core/view-model/rule';
import { Heading } from '@/component-library/atoms/misc/Heading';
import Timeline from '@/component-library/features/Timeline';
import { HiArrowLeft, HiArrowRight } from 'react-icons/hi';
import { Button } from '@/component-library/atoms/form/button';
import { CreateRuleStageData } from '@/lib/infrastructure/client/pages/Rule/create/stage-dids/CreateRuleStageData';
import { CreateRuleStageStorage } from '@/lib/infrastructure/client/pages/Rule/create/stage-rses/CreateRuleStageStorage';
import { LoadingSpinner } from '@/component-library/atoms/loading/LoadingSpinner';
import {
    CreateRuleOptionsErrors,
    CreateRuleStageOptions,
    getEmptyOptionsErrors,
} from '@/lib/infrastructure/client/pages/Rule/create/stage-options/CreateRuleStageOptions';
import { ListDIDsViewModel } from '@/lib/core/view-model/list-did';
import { CreateRuleStageSummary } from '@/lib/infrastructure/client/pages/Rule/create/stage-summary/CreateRuleStageSummary';
import { CreateRuleStageSubmission } from '@/lib/infrastructure/client/pages/Rule/create/stage-submission/CreateRuleStageSubmission';

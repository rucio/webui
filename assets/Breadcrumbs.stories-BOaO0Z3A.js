import{i as e,l as t}from"./preload-helper-DID7B_--.js";import{kt as n,on as r}from"./iframe-B1_WYtkJ.js";import{n as i,t as a}from"./utils-BlOR3gwo.js";import{b as o,l as s,m as c,p as l,rt as u,y as d}from"./index.esm-CS54JB2F.js";import{n as f,t as p}from"./dist-Bwk7AIxR.js";import{n as m,t as h}from"./link-DXS6XSUO.js";var g,_,v,y,b,x=e((()=>{g=n(),_=t(r()),f(),i(),u(),h(),v=p(`flex items-center flex-wrap gap-2 text-sm`,{variants:{size:{sm:`text-xs`,md:`text-sm`,lg:`text-base`}},defaultVariants:{size:`md`}}),y=p(`transition-colors`,{variants:{active:{true:`text-neutral-900 dark:text-neutral-100 font-medium`,false:`text-neutral-600 dark:text-neutral-400 hover:text-brand-600 dark:hover:text-brand-500`}}}),b=_.forwardRef(({className:e,size:t,items:n,separator:r,showHomeIcon:i=!1,maxItems:c,homeHref:l=`/`,...u},d)=>{let f=r??(0,g.jsx)(s,{className:`h-4 w-4 text-neutral-400 dark:text-neutral-600`}),p=n;if(c&&n.length>c){let e=n.slice(0,1),t=n.slice(-(c-2));p=[...e,{label:`...`,href:void 0},...t]}return(0,g.jsx)(`nav`,{ref:d,"aria-label":`Breadcrumb`,className:a(v({size:t}),e),...u,children:(0,g.jsxs)(`ol`,{className:`flex items-center flex-wrap gap-2`,children:[i&&(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`li`,{children:(0,g.jsx)(m,{href:l,className:a(y({active:!1})),children:(0,g.jsx)(o,{className:`h-4 w-4`,"aria-label":`Home`})})}),p.length>0&&(0,g.jsx)(`li`,{"aria-hidden":`true`,children:f})]}),p.map((e,t)=>{let n=t===p.length-1,r=e.label===`...`;return(0,g.jsxs)(_.Fragment,{children:[(0,g.jsx)(`li`,{children:r?(0,g.jsx)(`span`,{className:`text-neutral-600 dark:text-neutral-400`,"aria-label":`More items`,children:e.label}):e.href&&!n?(0,g.jsxs)(m,{href:e.href,className:a(y({active:!1})),children:[e.icon&&(0,g.jsx)(`span`,{className:`mr-1`,children:e.icon}),e.label]}):(0,g.jsxs)(`span`,{className:a(y({active:n})),"aria-current":n?`page`:void 0,children:[e.icon&&(0,g.jsx)(`span`,{className:`mr-1`,children:e.icon}),e.label]})}),!n&&(0,g.jsx)(`li`,{"aria-hidden":`true`,children:f})]},t)})]})})}),b.displayName=`Breadcrumbs`,b.__docgenInfo={description:`Breadcrumbs navigation component for hierarchical navigation

import{i as e,l as t}from"./preload-helper-DID7B_--.js";import{kt as n,on as r}from"./iframe-B1_WYtkJ.js";import{n as i,t as a}from"./RucioLogo-wzxAJjhv.js";import{n as o,t as s}from"./button-CECyO8DS.js";import{n as c,r as l}from"./Heading-DQSwUPQc.js";import{n as u,t as d}from"./link-DXS6XSUO.js";import{n as f,t as p}from"./PageContainer-BF0SECsP.js";import{n as m,t as h}from"./Section-DksNZjR3.js";var g,_,v,y=e((()=>{g=n(),_=t(r()),d(),f(),m(),i(),l(),o(),v=_.forwardRef(({heading:e=`Something went wrong`,errorMessage:t=`An unexpected error occurred while processing your request.`,errorDigest:n,onRetry:r,returnUrl:i=`/dashboard`,returnLabel:o=`Return to Dashboard`,logoSize:l=100,className:d,helpText:f=`If this error persists, please contact your system administrator or check the browser console for more details.`},m)=>(0,g.jsx)(p,{ref:m,centered:!0,className:`min-h-screen flex items-center justify-center ${d||``}`,children:(0,g.jsx)(h,{className:`max-w-2xl mx-auto text-center`,role:`alert`,"aria-live":`assertive`,"aria-label":`Application error`,children:(0,g.jsxs)(`div`,{className:`flex flex-col items-center space-y-6`,children:[(0,g.jsx)(a,{width:l,height:l,className:`text-base-error-500 dark:text-base-error-400`,"aria-label":`Rucio Logo`}),(0,g.jsxs)(`div`,{className:`space-y-2`,children:[(0,g.jsx)(c,{text:e,size:`lg`,className:`text-base-error-500 dark:text-base-error-400`}),(0,g.jsx)(`p`,{className:`text-base text-neutral-600 dark:text-neutral-400`,children:t}),n&&(0,g.jsxs)(`p`,{className:`text-sm text-neutral-500 dark:text-neutral-500 font-mono`,children:[`Error ID: `,n]})]}),(0,g.jsxs)(`div`,{className:`flex flex-col sm:flex-row gap-4 w-full sm:w-auto sm:justify-center mt-4`,children:[r&&(0,g.jsx)(s,{variant:`default`,size:`default`,onClick:r,className:`w-full sm:w-auto`,"aria-label":`Try again and reload the page`,children:`Try Again`}),(0,g.jsx)(u,{href:i,className:`w-full sm:w-auto`,children:(0,g.jsx)(s,{variant:`neutral`,size:`default`,className:`w-full`,"aria-label":o,children:o})})]}),f&&(0,g.jsx)(`p`,{className:`text-sm text-neutral-500 dark:text-neutral-500 mt-8`,children:f})]})})})),v.displayName=`ErrorPage`,v.__docgenInfo={description:`ErrorPage component

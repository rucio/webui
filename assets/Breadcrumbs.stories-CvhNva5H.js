import{r as W,j as e,R as da}from"./iframe-CW9-_HYS.js";import{c as sa}from"./index-DSpI4bVK.js";import{c as m}from"./utils-DsKtx5Xo.js";import{A as ia,p as ma,B as ra,C as la,D as ta}from"./index.esm-DWUw-EzS.js";import{L as M}from"./link-CzcqeJGl.js";import"./preload-helper-Dp1pzeXC.js";import"./tw-merge-Ds6tgvmq.js";import"./iconBase-_tCx069T.js";const ha=sa("flex items-center flex-wrap gap-2 text-sm",{variants:{size:{sm:"text-xs",md:"text-sm",lg:"text-base"}},defaultVariants:{size:"md"}}),z=sa("transition-colors",{variants:{active:{true:"text-neutral-900 dark:text-neutral-100 font-medium",false:"text-neutral-600 dark:text-neutral-400 hover:text-brand-600 dark:hover:text-brand-500"}}}),s=W.forwardRef(({className:a,size:o,items:l,separator:E,showHomeIcon:T=!1,maxItems:t,homeHref:n="/",...na},oa)=>{const F=E??e.jsx(ma,{className:"h-4 w-4 text-neutral-400 dark:text-neutral-600"});let c=l;if(t&&l.length>t){const r=l.slice(0,1),d=l.slice(-(t-2));c=[...r,{label:"...",href:void 0},...d]}return e.jsx("nav",{ref:oa,"aria-label":"Breadcrumb",className:m(ha({size:o}),a),...na,children:e.jsxs("ol",{className:"flex items-center flex-wrap gap-2",children:[T&&e.jsxs(e.Fragment,{children:[e.jsx("li",{children:e.jsx(M,{href:n,className:m(z({active:!1})),children:e.jsx(ia,{className:"h-4 w-4","aria-label":"Home"})})}),c.length>0&&e.jsx("li",{"aria-hidden":"true",children:F})]}),c.map((r,d)=>{const i=d===c.length-1,ca=r.label==="...";return e.jsxs(W.Fragment,{children:[e.jsx("li",{children:ca?e.jsx("span",{className:"text-neutral-600 dark:text-neutral-400","aria-label":"More items",children:r.label}):r.href&&!i?e.jsxs(M,{href:r.href,className:m(z({active:!1})),children:[r.icon&&e.jsx("span",{className:"mr-1",children:r.icon}),r.label]}):e.jsxs("span",{className:m(z({active:i})),"aria-current":i?"page":void 0,children:[r.icon&&e.jsx("span",{className:"mr-1",children:r.icon}),r.label]})}),!i&&e.jsx("li",{"aria-hidden":"true",children:F})]},d)})]})})});s.displayName="Breadcrumbs";s.__docgenInfo={description:`Breadcrumbs navigation component for hierarchical navigation
...
}`,...(q=(O=h.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var G,_,K;b.parameters={...b.parameters,docs:{...(G=b.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    items: [{
      label: 'Dashboard',
      href: '/dashboard'
...
}`,...(oe=(ne=x.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var ce,de,ie;v.parameters={...v.parameters,docs:{...(ce=v.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    size: 'md',
    items: [{
      label: 'Dashboard',
...
}`,...(ie=(de=v.parameters)==null?void 0:de.docs)==null?void 0:ie.source}}};var me,he,be;j.parameters={...j.parameters,docs:{...(me=j.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    size: 'lg',
    items: [{
      label: 'Dashboard',
...
}`,...(He=(we=S.parameters)==null?void 0:we.docs)==null?void 0:He.source}}};var ke,Ae,Ie;P.parameters={...P.parameters,docs:{...(ke=P.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  render: () => <div className="p-6 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
            <Breadcrumbs items={[{
      label: 'Rules',
      href: '/rules'
...
}`,...(Ie=(Ae=P.parameters)==null?void 0:Ae.docs)==null?void 0:Ie.source}}};var Re,Ce,Be;w.parameters={...w.parameters,docs:{...(Re=w.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  render: () => <div className="p-6 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
...
}`,...(Me=(We=k.parameters)==null?void 0:We.docs)==null?void 0:Me.source}}};var Ve,Oe,qe;A.parameters={...A.parameters,docs:{...(Ve=A.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
...
}`,...(qe=(Oe=A.parameters)==null?void 0:Oe.docs)==null?void 0:qe.source}}};var Ge,_e,Ke;I.parameters={...I.parameters,docs:{...(Ge=I.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
...
}`,...(Ke=(_e=I.parameters)==null?void 0:_e.docs)==null?void 0:Ke.source}}};var Ue,$e,Je;R.parameters={...R.parameters,docs:{...(Ue=R.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {

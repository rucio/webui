...
import { fixtureRSEAccountUsageLimitViewModel, generateSequenceArray } from "test/fixtures/table-fixtures";
...
async function endpoint(req: NextApiRequest, res: NextApiResponse, rucioAuthToken: string) {
    ...
    const data = generateSequenceArray(10, fixtureRSEAccountUsageLimitViewModel)

...
export const PageDID = (props: PageDIDPageProps) => {
        ...
        <div className={twMerge('flex flex-col space-y-2 w-full')}>
            ...
            <Body>
                ...
                <SubPage
                    ...
                    run={() => {
                        if (props.didRulesComDOM.query.data.all.length === 0) {
                            props.didRulesComDOM.start();
                        }
                    }}
                    id="subpage-rules"
                >
                ...
                <SubPage
                    ...
                    run={() => {
                        if (props.didDatasetReplicasComDOM.query.data.all.length === 0) {
                            props.didDatasetReplicasComDOM.start();
                        }
                    }}
                ...
                <SubPage
                    ...
                    run={() => {
                        if (props.didFileReplicasComDOM.query.data.all.length === 0) {
                            props.didFileReplicasComDOM.start();
                        }
                    }}
                ...
                <SubPage
                    ...
                    run={() => {
                        if (props.didContentsComDOM.query.data.all.length === 0) {
                            props.didContentsComDOM.start();
                        }
                    }}
                ...
                <SubPage
                    ...
                    run={() => {
                        if (props.didParentsComDOM.query.data.all.length === 0) {
                            props.didParentsComDOM.start();
                        }
                    }}
                ...
                <SubPage show={showPageBools['subpage-metadata']()} id="subpage-metadata">

...
export const ListDID = (props: ListDIDPageProps) => {
    ...
    return (
        <div className={twMerge('flex flex-col space-y-2 w-full')}>
            <Heading title="List DIDs">
                <form className={twMerge('flex flex-col sm:flex-row sm:space-x-2 sm:items-end w-full ')} aria-label="DID Search">
                    ...
                    <div className="grow">
                        <TextInput
                            onBlur={(event: any) => {
                                setDidSearchQuery(event.target.value);
                            }}
                ...
                <div className={twMerge('w-full flex flex-col p-2 rounded', 'bg-neutral-200 dark:bg-neutral-900')}>
                    ...
                    >
                        ...
                        <Checkbox
                            ...
                            onChange={(e: any) => {
                                setDidTypeAllowed(e.target.id as DIDType);
                            }}
            ...
            <Body className={twMerge('grid grid-rows-2 gap-y-2 lg:grid-rows-1 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-2')}>
                <div className={twMerge('bg-neutral-0 dark:bg-neutral-900', 'min-w-0', 'lg:col-span-2')}>
                    <ListDIDTable
                        comdom={props.comdom}
                ...
                <div className={twMerge('bg-neutral-100 dark:bg-neutral-900', 'rounded-md p-2', 'flex flex-col space-y-2')}>
                    ...
                    <div
                        className={twMerge('text-text-800 dark:text-text-100', !selectedDID ? 'block' : 'hidden')}
                        aria-label="Notice: No DID selected"
                    >
                        <i className="dark:text-text-200 text-text-1000">No DID selected</i>
                    </div>
                    <div className={twMerge(selectedDID ? '' : 'hidden')} aria-label="Go To DID Page">
                        <Link
                            className={twMerge(

    ...
    *  ================================================= */
    return (
        ...
        >
            ...
            <Body>
                <CreateRuleDIDsPage setDIDS={setSelectedDID} activePage={activePage} setActivePage={setActivePage} CreateRulePageProps={props} pagePrevFunction={pagePrevFunction}></CreateRuleDIDsPage>
                
                <CreateRuleRSEsPage setRses={setRSEsInformation} activePage={activePage} setActivePage={setActivePage} CreateRulePageProps={props} pagePrevFunction={pagePrevFunction} selectedDIDs={selectedDIDs}></CreateRuleRSEsPage>

                <CreateRuleOptionsPage setOptions={setOptions} activePage={activePage} setActivePage={setActivePage} CreateRulePageProps={props} pagePrevFunction={pagePrevFunction} selectedDIDs={selectedDIDs} RSEsInformation={RSEsInformation} setSummaryViewModel={setSummaryViewModel}></CreateRuleOptionsPage>
                
                <CreateRuleSummaryPage activePage={activePage} setActivePage={setActivePage} CreateRulePageProps={props} pagePrevFunction={pagePrevFunction} selectedDIDs={selectedDIDs} RSEsInformation={RSEsInformation} summaryViewModel={summaryViewModel} setQueryResults={setQueryResults} Options={Options} ></CreateRuleSummaryPage>
                
                <CreateRuleStatusTabPage activePage={activePage} QueryStatus={QueryResults} pagePrevFunction={pagePrevFunction}></CreateRuleStatusTabPage>
            </Body>
        </div>
    )
}

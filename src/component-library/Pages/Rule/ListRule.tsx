                    ...
                    <fieldset className={twMerge('w-full rounded', 'bg-neutral-200 dark:bg-neutral-900 dark:text-text-0 text-text-1000')}>
                        <Generaltable className={twMerge('bg-inherit dark:bg-inherit dark:text-text-0 text-text-1000')}>
                            <tr>
                                ...
                                <Contenttd>
                                    <TextInput onChange={e => setUserdefinequery({ ...userdefinequery, account: e.target.value })} />
                                </Contenttd>
                            </tr>
                            <tr>
                                <Titleth>RSE Expression</Titleth>
                                <Contenttd>
                                    <TextInput onChange={e => setUserdefinequery({ ...userdefinequery, rse_expression: e.target.value })} />
                                </Contenttd>
                            </tr>
                            <tr>
                                <Titleth>Activity</Titleth>
                                <Contenttd>
                                    <TextInput onChange={e => setUserdefinequery({ ...userdefinequery, activity: e.target.value })} />
                                </Contenttd>
                            </tr>
                            <tr>

...
import { fixtureRSEAttributeViewModel, mockUseComDOM } from "test/fixtures/table-fixtures";
...
PageRSEAttributes.args = {
    comdom: mockUseComDOM(Array.from({ length: 20 }, (_, i) => fixtureRSEAttributeViewModel()))
};

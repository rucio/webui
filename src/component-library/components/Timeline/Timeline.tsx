...
export const Timeline = (
    ...
    var noClickClasses = ["flex", "items-center", "gap-2", "bg-white", "dark:bg-[#1B1C1D]", "p-2", "hover:cursor-default"]
    var clickableClasses = ["flex", "items-center", "gap-2", "bg-white", "dark:bg-[#1B1C1D]", "p-2", "hover:cursor-pointer"]

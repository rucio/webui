...
export const TablePaginationNav: React.FC<JSX.IntrinsicElements["div"] & {
    table: Table<any>;
}> = (
    {
        table,
        ...
        return (
            <nav
                className={twMerge(
                    "w-full flex justify-center space-x-1 sm:space-x-2 h-8"
                )}
            ...
            >
                ...
                <span className="w-1/3 inline-flex space-x-1 md:space-x-2 items-end">
                    ...
                    />
                    <span
                        className="w-full dark:text-text-0 text-text-1000"

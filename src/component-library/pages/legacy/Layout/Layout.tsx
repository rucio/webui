...
export const Layout = (props: { children: React.ReactNode; LVM: LayoutViewModel }) => {
    ...
    const HeaderLinks: React.FC<JSX.IntrinsicElements['a']> = ({ ...props }) => {
        return (
            <a className={twMerge('hover:text-text-400 font-bold text-l hover:cursor-pointer text-text-100', props.className ?? '')} {...props}>
                {props.children}
            </a>
        );
    };
    ...
    return (
        <div className={twMerge('dark:bg-neutral-900 bg-neutral-0', 'h-full min-h-screen', 'flex flex-col')}>
            ...
            <main className={twMerge('lg:px-24 xl:px-36 py-4 md:py-8', 'flex flex-col grow', 'z-[10]')}>{props.children}</main>
            <Toaster />
            <footer className={twMerge('border-t', 'h-16 p-2', 'text-text-500', 'flex')}>
                <div className={twMerge('grow', 'flex flex-row space-x-2 items-end')}>
                ...
                <div className={twMerge('w-72', 'grid grid-flow-col-dense grid-cols-2 grid-rows-2')}>
                    <a href="/docs/api" className="hover:text-brand-500">
                        API
                    </a>
                    <a href="/privacy" className="hover:text-brand-500">
                        Privacy
                    </a>
                    <a href="/docs" className="hover:text-brand-500">
                        Docs
                    </a>
                    <a href="/status" className="hover:text-brand-500">
                        Status
                    </a>
                </div>
            </footer>

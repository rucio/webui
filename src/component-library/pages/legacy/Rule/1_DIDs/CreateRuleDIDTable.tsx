...
export const CreateRuleDIDTable = (props: { comdom: UseComDOM<ListDIDsViewModel>; handleChange: (data: ListDIDsViewModel[]) => void }) => {
    ...
    const tablecolumns: any[] = [
            ...
            header: info => {
                return (
                    <TableFilterDiscrete<DIDType>
                        ...
                        renderFunc={state =>
                            state === undefined ? (
                                <HiDotsHorizontal className="text-xl text-text-500 dark:text-text-200" />
                            ) : (
        ...
        columnHelper.accessor('bytes', {
            id: 'bytes',
            header: info => {
                return <TableSortUpDown name="Bytes" column={info.column} />;
            },
            cell: info => {
                return (

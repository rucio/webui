            ...
            >
                <div className="flex flex-col space-y-2 m-2">
                    <div className="flex w-full flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0">
                        ...
                        <div className="grow">
                            <TextInput
                                id="rse-expression"
                                onBlur={event => {
                                    setPageRSEsState({ ...PageRSEsState, RSEExpression: event.target.value });
                                }}
                                onEnterkey={event => {
                                    setPageRSEsState({ ...PageRSEsState, RSEExpression: event.target.value });
                                    pageRSESearch(event, event.target.value);
                                }}
                            />
                        </div>
                    ...
                    <CreateRuleRSETable
                        ...
                        handleChange={(data: RSEAccountUsageLimitViewModel[]) => {
                            setPageRSEsState({ ...PageRSEsState, RSESelection: data });
                        }}
                    ...
                    <div>
                        <Checkbox
                            ...
                            type="checkbox"
                            onChange={(event: any) => {
                                setPageRSEsState({ ...PageRSEsState, askForApproval: event.target.checked });
                            }}

...
import { Checkbox } from '@/component-library/atoms/legacy/Checkbox/Checkbox';
...
import { NumInput } from '@/component-library/atoms/legacy/input/NumInput/NumInput';
import { SamplingTag } from '@/component-library/features/legacy/Tags/SamplingTag';
    ...
    return (
        <>
            <RulePage
                ...
                progressBlocked={PageOptionsState.page2progressBlocked}
                onNext={() => {
                    loadRuleSummaryPage();
                }}
                    ...
                    <div className="flex flex-col space-y-2 md:w-60 w-full">
                        <div className="w-full">
                            ...
                            <LifetimeWithExpirationDateInput
                                ...
                                onChange={(date: Date, lifetime: number) => {
                                    setPageOptionsState({ ...PageOptionsState, expiryDate: date, lifetime: lifetime });
                                }}
                            />
                        </div>
                        <div className="w-full">
                            ...
                            <NumInput
                                ...
                                min={1}
                                onChange={(event: any) => {
                                    setPageOptionsState({ ...PageOptionsState, numcopies: event.target.value });
                                }}
                                id="numCopies"
                            />
                        </div>
                        <div className="w-full">
                            <Checkbox
                                ...
                                onChange={(event: any) => {
                                    setPageOptionsState({ ...PageOptionsState, enableNotifications: event.target.checked });
                                }}
                    ...
                    <div className="border rounded-md p-2 grow">
                        <div className="flex w-full justify-start space-x-2">
                            <div className="w-24">
                                <Button
                                    label="Advanced"
                                    onClick={() => {
                                        setPageOptionsState({ ...PageOptionsState, showAdvanced: !PageOptionsState.showAdvanced });
                                    }}
                                />
                            </div>
                        ...
                        <Collapsible showIf={PageOptionsState.showAdvanced}>
                            <div className="flex flex-col space-y-2 mt-2">
                                <div className="w-full">
                                    <label className="hidden" htmlFor="item-grouping-dropdown">
                                        Item Grouping
                                    </label>
                                    <Dropdown
                                        handleChange={(element: any) => {
                                            setPageOptionsState({ ...PageOptionsState, groupBy: element });
                                        }}
                                ...
                                <div className="">
                                    <Checkbox
                                        ...
                                        onChange={(event: any) => {
                                            setPageOptionsState({ ...PageOptionsState, asynchronousMode: event.target.checked });
                                        }}
                                ...
                                <div className="w-full">
                                    ...
                                    <AreaInput
                                        ...
                                        rows={3}
                                        onChange={event => {
                                            setPageOptionsState({ ...PageOptionsState, freeComment: event.target.value });
                                        }}
                                ...
                                >
                                    <div className="flex flex-row justify-start space-x-2">
                                        <input
                                            ...
                                            id="create-sample"
                                        />
                                        <label htmlFor="create-sample" className="text-text-1000 dark:text-text-100">
                                            Create Sample
                                        </label>
                                    </div>
                                    <div className="grow flex flex-col justify-end">
                                        ...
                                        <NumInput
                                            ...
                                            onChange={(event: any) => {
                                                setPageOptionsState({ ...PageOptionsState, numsamples: event.target.value });
                                            }}
                                            id="numSamples"
                                            min={1}

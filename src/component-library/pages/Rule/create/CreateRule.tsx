    ...
    return (
        <div className="flex flex-col space-y-3 w-full grow">
            ...
            <div className="flex justify-between">
                <Button className="w-fit justify-between"
                        onClick={() => setActiveIndex((prevState) => prevState - 1)}><HiArrowLeft/></Button>
                <Button className="w-fit justify-between"
                        onClick={() => setActiveIndex((prevState) => prevState + 1)}><HiArrowRight/></Button>
            </div>
        </div>
    );
};

export const TimelineLiSpan = (props: { children: any; highlight: boolean; completed?: boolean }) => {
    ...
    const highlightClasses = classes.concat('bg-blue-600', 'text-white');
    const completedClasses = classes.concat('bg-green-600', 'text-white');
    const normalClasses = classes.concat('bg-gray-200', 'dark:bg-gray-600');
    return (

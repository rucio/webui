...
/**
 * GET /api/feature/mock-list-rules
 * Mock streaming endpoint for testing rule listing with NDJSON format
 * Returns a stream of mock rule data for development/testing
 */
export async function GET() {
    return executeAuthenticatedStream(async (user, token) => {
        try {
            ...
            console.error('Error in mock-list-rules:', error);
            return new Response(
                JSON.stringify({

...
export default function QueryInfo({title, status, realStatus}: QueryInfoProps) {
    ...
    return (
        <div>
            ...
            <a href="#" className={`block max-w-sm p-6 ${backgroundColor} border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:hover:bg-gray-700`}>
                <div >

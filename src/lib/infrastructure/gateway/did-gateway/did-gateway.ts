...
import { DID, DIDAvailability, DIDType, DIDFilter } from '@/lib/core/entity/rucio';
...
export default class RucioDIDGateway implements DIDGatewayOutputPort {
    ...
    async listDIDs(rucioAuthToken: string, scope: string, name: string, type: DIDType, filters: DIDFilter[] = []): Promise<ListDIDDTO> {
        try {

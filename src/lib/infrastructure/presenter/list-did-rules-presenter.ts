...
export default class ListDIDRulesPresenter extends BaseStreamingPresenter<ListDIDRulesResponse, ListDIDRulesError, DIDRulesViewModel> implements ListDIDRulesOutputPort {

...
export default class ListAllRSEsPresenter extends BaseStreamingPresenter<ListAllRSEsResponse, ListAllRSEsError, RSEViewModel> implements ListAllRSEsOutputPort {

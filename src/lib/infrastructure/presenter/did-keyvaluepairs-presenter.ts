...
export default class DIDKeyValuePairsDataPresenter extends BasePresenter<DIDKeyValuePairsDataResponse, DIDKeyValuePairsDataError, DIDKeyValuePairsDataViewModel> {

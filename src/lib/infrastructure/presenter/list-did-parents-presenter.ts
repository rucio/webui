...
} from '@/lib/core/usecase-models/list-did-parents-usecase-models'
...
export default class ListDIDParentsPresenter extends BaseStreamingPresenter<ListDIDParentsResponse, ListDIDParentsError, DIDViewModel> implements ListDIDParentsOutputPort {

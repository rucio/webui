...
export default class ListAccountRSEUsagePresenter extends BaseStreamingPresenter<ListAccountRSEUsageResponse, ListAccountRSEUsageError, RSEAccountUsageViewModel> implements ListAccountRSEUsageOutputPort {

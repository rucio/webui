...
import { BaseStreamableFeature, IFeature, IOCSymbols } from '@/lib/sdk/ioc-helpers';
...
> {
    constructor(appContainer: Container) {
        ...
        super('ListDIDs', ListDIDsController, ListDIDsUseCase, [didGateway], ListDIDsPresenter, false, symbols);
    }
}

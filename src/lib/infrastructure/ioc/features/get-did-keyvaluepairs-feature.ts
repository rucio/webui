import { DIDKeyValuePairsDataRequest, DIDKeyValuePairsDataResponse, DIDKeyValuePairsDataError } from "@/lib/core/usecase-models/did-keyvaluepairs-usecase-models";

 ...
 */
export interface ListAccountRSEQuotasOutputPort extends BaseStreamingOutputPort<ListAccountRSEQuotasResponse, ListAccountRSEQuotasError, RSEAccountUsageLimitViewModel>{}
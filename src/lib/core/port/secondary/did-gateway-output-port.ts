...
import { DIDShort, DIDType, DIDFilter } from '../../entity/rucio';
...
export default interface DIDGatewayOutputPort {
     ...
     * @returns A Promise that resolves to a {@link ListDIDDTO} object.
     */
    listDIDs(rucioAuthToken: string, scope: string, name: string, type: DIDType, filters?: DIDFilter[]): Promise<ListDIDDTO>;

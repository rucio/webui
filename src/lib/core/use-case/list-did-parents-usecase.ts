...
@injectable()
export default class ListDIDParentsUseCase
    extends BaseSingleEndpointStreamingUseCase<
        AuthenticatedRequestModel<ListDIDParentsRequest>,
        ...
        DIDViewModel
    >
    implements ListDIDParentsInputPort
{
    constructor(protected readonly presenter: ListDIDParentsOutputPort, private readonly gateway: DIDGatewayOutputPort) {
        super(presenter);
    }
    ...
    async intializeRequest(
        request: AuthenticatedRequestModel<AuthenticatedRequestModel<ListDIDParentsRequest>>,
    ): Promise<ListDIDParentsError | undefined> {
        return undefined;
    }

...
@injectable()
export default class GetRSEAttributesUseCase extends BaseSingleEndpointUseCase<AuthenticatedRequestModel<GetRSEAttributesRequest>, GetRSEAttributesResponse, GetRSEAttributesError, RSEAttributeDTO> implements GetRSEAttributesInputPort {
   
    constructor(
        protected readonly presenter: GetRSEAttributesOutputPort,

...
import { ListSubscriptionRuleStatesError, ListSubscriptionRuleStatesRequest, ListSubscriptionRuleStatesResponse } from "@/lib/core/usecase-models/list-subscription-rule-states-usecase-models";
import { ListSubscriptionRuleStatesInputPort, type ListSubscriptionRuleStatesOutputPort } from "@/lib/core/port/primary/list-subscription-rule-states-ports";
...
@injectable()
export default class ListSubscriptionRuleStatesUseCase extends BaseSingleEndpointStreamingUseCase<AuthenticatedRequestModel<ListSubscriptionRuleStatesRequest>, ListSubscriptionRuleStatesResponse, ListSubscriptionRuleStatesError, BaseStreamableDTO, SubscriptionRuleStateDTO, SubscriptionRuleStatesViewModel> implements ListSubscriptionRuleStatesInputPort {
    ...
    async makeGatewayRequest(requestModel: AuthenticatedRequestModel<ListSubscriptionRuleStatesRequest>): Promise<BaseStreamableDTO> {
        const { rucioAuthToken, account, name } = requestModel;
        const dto: BaseStreamableDTO = await this.gateway.listSubscriptionRuleStates(rucioAuthToken, account, name);
        return dto;
    }
    ...
    processStreamedData(dto: SubscriptionRuleStateDTO): { data: ListSubscriptionRuleStatesResponse | ListSubscriptionRuleStatesError; status: "success" | "error"; } {

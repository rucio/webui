...
@injectable()
export default class GetRSEUsageUseCase
    extends BaseSingleEndpointUseCase<AuthenticatedRequestModel<GetRSEUsageRequest>, GetRSEUsageResponse, GetRSEUsageError, RSEUsageDTO>
    implements GetRSEUsageInputPort
{
    constructor(protected readonly presenter: GetRSEUsageOutputPort, private readonly gateway: RSEGatewayOutputPort) {
        super(presenter);
    }

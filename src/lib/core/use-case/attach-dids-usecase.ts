...
@injectable()
export default class AttachDIDsUseCase
    extends BaseSingleEndpointUseCase<AuthenticatedRequestModel<AttachDIDsRequest>, AttachDIDsResponse, AttachDIDsError, AttachDIDDTO>
    implements AttachDIDsInputPort
{
    constructor(protected readonly presenter: AttachDIDsOutputPort, private readonly gateway: DIDGatewayOutputPort) {
        super(presenter);
    }

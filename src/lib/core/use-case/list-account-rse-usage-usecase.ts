...
import {
    ListAccountRSEUsageInputPort,
    type ListAccountRSEUsageOutputPort
} from "@/lib/core/port/primary/list-account-rse-usage-ports";
...
@injectable()
export default class ListAccountRSEUsageUseCase extends BaseSingleEndpointStreamingUseCase<AuthenticatedRequestModel<ListAccountRSEUsageRequest>, ListAccountRSEUsageResponse, ListAccountRSEUsageError, ListAccountRSEUsageDTO, AccountRSEUsageDTO, RSEAccountUsageViewModel> implements ListAccountRSEUsageInputPort {
    constructor(
        protected readonly presenter: ListAccountRSEUsageOutputPort,
    ...
    intializeRequest(request: AuthenticatedRequestModel<AuthenticatedRequestModel<ListAccountRSEUsageRequest>>): Promise<ListAccountRSEUsageError | undefined> {

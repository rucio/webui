...
@injectable()
export default class GetAccountInfoUseCase
    extends BaseSingleEndpointUseCase<AuthenticatedRequestModel<GetAccountInfoRequest>, GetAccountInfoResponse, GetAccountInfoError, AccountInfoDTO>
    implements GetAccountInfoInputPort
{
    constructor(protected readonly presenter: GetAccountInfoOutputPort, private readonly gateway: AccountGatewayOutputPort) {
        super(presenter);
    }

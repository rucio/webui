    ...
    implements BaseStreamingOutputPort<TResponseModel, TErrorModel, TStreamViewModel>
{
     ...
     */
    abstract streamResponseModelToViewModel(responseModel: TResponseModel): TStreamViewModel;
    ...
    _transform(chunk: TResponseModel | TErrorModel, encoding: BufferEncoding, callback: TransformCallback): void {
        try {

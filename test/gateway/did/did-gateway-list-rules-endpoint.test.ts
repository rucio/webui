        ...
        const didListRulesMockEndpoint: MockEndpoint = {
            ...
            response: {
                ...
                body: Readable.from( [
                    ...
                    JSON.stringify({"id":"abc123xyz456","subscription_id":null,"account":"user123","scope":"project_data","name":"experiment_data_001","did_type":"FILE","state":"PROCESSING","error":null,"rse_expression":"backup_storage","copies":2,"expires_at":null,"weight":null,"locked":false,"locks_ok_cnt":789,"locks_replicating_cnt":1,"locks_stuck_cnt":0,"source_replica_expression":"source_data_center","activity":"Data Processing","grouping":"EXPERIMENT","notification":"YES","stuck_at":null,"purge_replicas":true,"ignore_availability":false,"ignore_account_limit":true,"priority":2,"comments":null,"child_rule_id":null,"eol_at":null,"split_container":true,"meta":null,"created_at":"Tue, 20 Jul 2023 08:45:19 UTC","updated_at":"Wed, 21 Jul 2023 14:20:37 UTC"})
                ].join("\n")),
            },
        };

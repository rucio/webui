...
describe('Heading Accessibility', () => {
        ...
        it('should have no violations with different variants', async () => {
            const { container } = render(
                <div>
                    ...
                    <Heading level="h2" variant="title">
                        Title Heading
                    </Heading>
                    <Heading level="h3" variant="subtitle">
                        Subtitle Heading
                    </Heading>
                </div>,
            );
        ...
        it('should have no violations with color variants', async () => {
            const { container } = render(
                <div>
                    ...
                    <Heading level="h2" className="text-brand-600">
                        Brand Color
                    </Heading>
    ...
    describe('Screen Reader Support', () => {
        ...
        it('should support aria-label for additional context', () => {
            render(
                <Heading level="h2" aria-label="User profile section">
                    Profile
                </Heading>,
            );
    ...
    describe('Section Association', () => {
        ...
        it('should support id for fragment links', () => {
            render(
                <Heading level="h2" id="introduction">
                    Introduction
                </Heading>,
            );

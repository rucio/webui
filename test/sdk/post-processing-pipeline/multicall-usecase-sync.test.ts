...
class FirstPipelineElement extends BasePostProcessingPipelineElement<RequestModel, TResponseModel, BaseErrorResponseModel, DTO> {
    ...
    transformResponseModel(responseModel: TResponseModel, dto: DTO): TResponseModel {
        responseModel.message = responseModel.message + dto.message + '_transformed';
        return responseModel;
    }
}

class ErrorPipelineElement extends BasePostProcessingPipelineElement<RequestModel, TResponseModel, BaseErrorResponseModel, DTO> {
    makeGatewayRequest(requestModel: RequestModel, responseModel: TResponseModel): Promise<DTO> {
        return Promise.resolve({
            status: 'error',
            errorCode: 401,

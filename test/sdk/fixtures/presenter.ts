...
export class TestPresenter extends BaseStreamingPresenter<BaseResponseModel, BaseErrorResponseModel, ViewModel> {
    ...
    streamResponseModelToViewModel(responseModel: TResponseModel): ViewModel {
        return {
            status: 'success',

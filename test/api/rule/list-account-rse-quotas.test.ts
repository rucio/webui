...
describe('Create Rule: List Account RSE Quotas', () => {
    beforeEach(() => {
        ...
        const rseAccountUsageStream = Readable.from(
            [
                JSON.stringify({
                    rse_id: '72fb4137ba3c460090bbd3fd8d490f8b',
                    rse: 'XRD1',
                    bytes: 500,
                    files: 8,
                    bytes_limit: Infinity,
                    bytes_remaining: Infinity,
                }),
                JSON.stringify({
                    rse_id: 'd72884a3eb1747cf979af8959c978aab',
                    rse: 'XRD2',
                    bytes: 100,
                    files: 2,
                    bytes_limit: 900,
                ...
                JSON.stringify({
                    rse_id: '2bb03a45a1b64b459cdc445d9844d936',
                    rse: 'XRD3',
                    bytes: 400,
                    files: 7,
                    bytes_limit: 600,
                ...
                JSON.stringify({
                    rse_id: '5883a989c9c047d99d2fc1c074e40f58',
                    rse: 'XRD4',
                    bytes: 300,
                    files: 6,
                    bytes_limit: 700,
                ...
                JSON.stringify({
                    rse_id: '5464fa3806324211ac5b490ce77acbfc',
                    rse: 'SSH1',
                    bytes: 200,
                    files: 3,
                    bytes_limit: 800,
        ...
        MockRucioServerFactory.createMockRucioServer(true, [
            accountInfoEndpoint,
            accountLimitEndpoint,
            listAccountRSEUsageEndpoint,
            listRSEsEndpoint,
        ]);
    });
    ...
    it('should return a list of account RSE quotas', async () => {
        ...
        const controller = appContainer.get<BaseController<ListAccountRSEQuotasControllerParameters, ListAccountRSEQuotasRequest>>(

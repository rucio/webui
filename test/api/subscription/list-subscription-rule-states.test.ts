...
describe('Get Subscription Rule States', () => {
    ...
    test('should return a list of subscription rule states', async () => {
        ...
        const listSubscriptionRuleStatesController = appContainer.get<BaseController<ListSubscriptionRuleStatesControllerParameters, ListSubscriptionRuleStatesRequest>>(CONTROLLERS.LIST_SUBSCRIPTION_RULE_STATES);

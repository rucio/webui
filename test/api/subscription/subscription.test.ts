...
describe('GET Subscription Feature Tests', () => {
    ...
    it('should get subscription', async () => {
        ...
        const getSubscriptionController = appContainer.get<BaseController<GetSubscriptionControllerParameters, GetSubscriptionRequest>>(
            CONTROLLERS.GET_SUBSCRIPTION,
        );

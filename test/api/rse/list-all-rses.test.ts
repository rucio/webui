...
describe('List RSEs Feature tests', () => {
        ...
        const rseStream = Readable.from(
            [
                JSON.stringify({
                    ...
                    region_code: null,
                    availability: 7,
                    created_at: 'Tue, 19 Sep 2023 13:19:02 UTC',
                    vo: 'def',
                    country_name: null,
                    availability_read: true,
                    updated_at: 'Tue, 19 Sep 2023 13:19:02 UTC',
                    rse_type: 'DISK',
                    continent: null,
                    ...
                    ASN: null,
                    deleted: false,
                    id: '59fcad356a68434cbe8c43737ccb3f83',
                    city: null,
                    longitude: null,
                    deleted_at: null,
                    latitude: null,
                ...
                JSON.stringify({
                    ...
                    ASN: null,
                    deleted: false,
                    id: '328c926f09ea4dc0a5ddfbe62c8e3bd5',
                    city: null,
                    longitude: null,
                    deleted_at: null,
                    latitude: null,
    ...
    it('should list rses as a stream', async () => {
        ...
        const controller = appContainer.get<BaseController<ListAllRSEsControllerParameters, ListAllRSEsRequest>>(CONTROLLERS.LIST_ALL_RSES);

...
describe("List File Replicas Feature tests", () => {
    ...
    it("should list File replicase for given FILE DID", async () => {
        ...
        const listFileReplicasController = appContainer.get<BaseController<ListFileReplicasControllerParameters, ListFileReplicasRequest>>(CONTROLLERS.LIST_FILE_REPLICAS);
